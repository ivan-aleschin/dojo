...
> и точечно — под конкретную секцию. 12-недельный объём под сентябрьский дедлайн не влезет целиком.
> Раздел про **Go** релевантен в основном Яндексу; для Т-Банк/МТС/WB (наши цели, Python) — опционально.
